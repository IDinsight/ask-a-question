...
const ConfirmDelete = ({
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto flex items-center justify-center">
      <div className="bg-white backdrop-blur bg-opacity-10 absolute inset-0"></div>
      <div className="bg-gray-200 p-4 rounded-lg z-20 shadow-lg">
        <h3
        ...
        <div className="bg-gray-200 px-4 py-3 sm:flex sm:flex-row-reverse mt-4 rounded-b-lg">
          <button
            type="button"
