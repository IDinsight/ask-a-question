...
resource "google_secret_manager_secret" "admin_username_secret" {
  secret_id = "${var.project_name}-${var.environment}-admin-username"
  labels = {
    autogenerated = "true"
  }
  replication {
...
resource "google_secret_manager_secret" "admin_password_secret" {
  secret_id = "${var.project_name}-${var.environment}-admin-password"
  labels = {
    autogenerated = "true"
  }
  replication {
...
resource "google_secret_manager_secret" "admin_api_key_secret" {
  secret_id = "${var.project_name}-${var.environment}-admin-api-key"
  labels = {
    autogenerated = "true"
  }
  replication {
...
resource "google_secret_manager_secret" "jwt_secret" {
  secret_id = "${var.project_name}-${var.environment}-jwt"
  labels = {
    autogenerated = "true"
  }
  replication {
...
resource "google_secret_manager_secret" "domain_secret" {
  secret_id = "${var.project_name}-${var.environment}-domain"
  labels = {
    autogenerated = "false"
  }
  replication {
...
resource "google_secret_manager_secret" "gcp_credential_json_secret" {
  secret_id = "${var.project_name}-${var.environment}-gcp-credential-json"
  labels = {
    autogenerated = "false"
  }
  replication {
...
resource "google_secret_manager_secret" "google_login_client_id_secret" {
  secret_id = "${var.project_name}-${var.environment}-google-login-client-id"
  labels = {
    autogenerated = "false"
  }
  replication {
...
resource "google_secret_manager_secret" "langfuse_public_key_secret" {
  secret_id = "${var.project_name}-${var.environment}-langfuse-public-key"
  labels = {
    autogenerated = "false"
  }
  replication {
...
resource "google_secret_manager_secret" "langfuse_secret_key_secret" {
  secret_id = "${var.project_name}-${var.environment}-langfuse-secret-key"
  labels = {
    autogenerated = "false"
  }
  replication {
